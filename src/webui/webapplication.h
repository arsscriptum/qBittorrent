...
private:
    ...
    const QHash<std::pair<QString, QString>, QString> m_allowedMethod =
    {
        ...
        {{u"net"_s, u"getIpInfo"_s}, Http::METHOD_GET},
        {{u"net"_s, u"refreshIpInfo"_s}, Http::METHOD_POST},
        {{u"net"_s, u"getNetSpeed"_s}, Http::METHOD_GET},
        {{u"net"_s, u"refreshNetSpeed"_s}, Http::METHOD_POST},
