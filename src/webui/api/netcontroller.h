...
#include "base/net/speedtestinfo.h"
class NETController final : public APIController
{
    Q_OBJECT
    Q_DISABLE_COPY_MOVE(NETController)

public:    
    explicit NETController(IApplication *app, QObject *parent = nullptr); // Fix constructor
    ~NETController() override;
